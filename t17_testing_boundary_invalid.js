/****************************
 Task-17 Testing Boundary Invalid
  Yuv Singh
  09/05/2025
...
if(ChocolateAffordability > 0){
  gfhGh= "You can afford a " + chocArray[ChocolateAffordability] + " for the price of $" + priceArray[ChocolateAffordability];
  console.log("Afford")
}else{
  gfhGh= "You can't afford anything.";
  console.log("Not afford")
}
document.getElementById("chocText").innerHTML= gfhGh;
}
